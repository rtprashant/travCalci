...
// Variants for the HOVER pill (the gray background)
            ...
            <LayoutGroup>
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="bg-black text-gray-100 shadow-md cursor-pointer flex items-center justify-center space-x-2 px-6 sm:px-10 py-3 z-10"
                    >
                        <motion.h1
                            layout
                    ...
                    <AnimatePresence>
                        {showNav && (
                            <motion.div
                                ...
                                className="mt-2 bg-black text-white rounded-xl px-6 sm:px-8 py-3 flex flex-col sm:flex-row sm:space-x-4 space-y-1 items-center shadow-lg"
                            >
                                    ...
                                    return (
                                        <Link to={item.path} key={item.name}>
                                            ...
                                            >
                                                ...
                                                {/* 2. Z-INDEX FIX: Wrapped text in a span with z-10 */}
                                                <span
                                                    className={`relative z-10 font-medium ${isActive ? "text-black" : "text-white"
                                                        }`}
                                                >
                                                    {item.name}
                                                </span>
