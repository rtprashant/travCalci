...
function AboutPage() {
    const teamMembers = [
        { name: "Divyansh Tyagi", title: "Founder & CEO", img: "https://placehold.co/400x400/E2E8F0/4A5568?text=Divyansh+T." },
        { name: "Prashant Kumar Rajput", title: "Lead Developer", img: "https://placehold.co/400x400/E2E8F0/4A5568?text=Prashant+K." },
        ...
        >
            ...
            <div
                ...
                style={{
                    ...
                    backgroundImage: `linear-gradient(rgba(2,6,23,0.65), rgba(2,6,23,0.35)), url(${aboutMain})`,
            ...
            >
                <motion.div
                    ...
                    variants={fadeIn}
                >
                    <h1 className="text-5xl md:text-6xl font-extrabold italic tracking-wide text-white drop-shadow-2xl">
                        About Travelory
                    </h1>
                    <p className="text-xl md:text-2xl text-white/90 mt-4 max-w-3xl mx-auto drop-shadow">
            ...
            <section className="py-16 sm:py-24 bg-gray-50">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {/* --- MODIFIED LINE --- */}
                    <motion.div
                        className="flex flex-wrap justify-center gap-8" // Use flex, wrap, and justify-center
                        variants={staggerContainer}
                        initial="hidden"
                        whileInView="visible"
                        viewport={{ once: true, amount: 0.2 }}
                    >
                        {teamMembers.map((member, index) => (
                            <motion.div
                                key={index}
                                // --- MODIFIED LINE ---
                                // Add a width so cards are uniform. Adjust w-72 as needed.
                                className="bg-white p-6 rounded-xl shadow-lg text-center w-full sm:w-72"
                                variants={fadeIn}
                            >
                                <img
                                    src={member.img}
            ...
            >
                <motion.div
                    ...
                    variants={fadeIn}
                >
                    <h2 className="text-3xl sm:text-4xl font-bold mb-6 drop-shadow-lg">Ready to Plan Your Next Adventure?</h2>
                    ...
                    <motion.a
                        href="/contact"
                        className="inline-block bg-white text-blue-700 font-bold text-base sm:text-lg px-8 py-3 sm:px-10 sm:py-4 rounded-xl shadow-2xl hover:bg-blue-50"
